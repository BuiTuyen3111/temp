...
import com.interactive.fitness.domain.model.ShortCut
import com.interactive.fitness.domain.model.ShortCutAction
...
class MainActivity : LeansoftSplashActivity() {
    ...
    private val pref get() = App.Companion.instance.pref
