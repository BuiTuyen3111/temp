...
import com.interactive.fitness.ext.findNavControllerSafely
import com.interactive.fitness.presentation.ui.activity.NavigationViewModel
import com.interactive.fitness.presentation.ui.dialog.ExitAppDialogFragment
import com.interactive.fitness.presentation.ui.home.HomeFragment
import com.interactive.fitness.presentation.ui.home.HomeVM
import com.interactive.fitness.utils.AppLog
...
abstract class BaseFragment<VB : ViewBinding, VM : BaseVM> : Fragment() {
    ...
    val pref get() = App.Companion.instance.pref
    val firebaseMgr get() = App.Companion.instance.firebaseMgr
